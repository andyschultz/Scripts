...
import sys,glob,linecache, pandas as pd, numpy as np
...
gp.write('set terminal pngcairo fontscale 3 size 1800,1200 font "Avenir Next,12"\n')
...
for file in nir:  
    ...
    gp.write('set ylabel "Transmission (%)" font "Avenir Next,09" offset 2.5,0\n')
    ...
    gp.write('plot [1000:2600][70:160] "'+file+'" u ($1*1000000000):3 w l ls 4 notitle\n')
    ...
    gp.write('set ytics nomirror font ",07" scale 0.5 0,5,10\n')
    gp.write('set boxwidth 0.9\n')
    gp.write('set yrange[0:10]\n')
    gp.write('set xrange[-0.15:0.4]\n')
    gp.write('set ytics nomirror font ",07" scale 0.5 0,5,10\n')
    gp.write('set label "H_2" font ",9" at graph 0.24,-0.18\n')
...
system('ffmpeg -f image2 -r 15 -i nir-transmission%5d.png -vcodec libx264 out.mp4')
system('rm *.png')